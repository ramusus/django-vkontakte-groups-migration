...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'GroupMigrationUser', fields ['type', 'user_id', 'migration']
    ...
    models = {
        ...
        u'vkontakte_groups_migration.groupmigration': {
            'Meta': {'ordering': "('group', '-time', '-id')", 'unique_together': "(('group', 'time'),)", 'object_name': 'GroupMigration'},
        ...
        u'vkontakte_groups_migration.groupmigrationold': {
            'Meta': {'ordering': "('group', 'time', '-id')", 'unique_together': "(('group', 'time'),)", 'object_name': 'GroupMigrationOld', 'db_table': "'vkontakte_groups_groupstatmembers'"},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'migrations_old'", 'to': u"orm['vkontakte_groups.Group']"}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'members_deactivated_entered_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),

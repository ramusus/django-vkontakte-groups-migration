...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'GroupMigration', fields ['time']
        db.create_index('vkontakte_groups_groupstatmembers', ['time'])

        # Adding index on 'GroupMigration', fields ['hidden']
        db.create_index('vkontakte_groups_groupstatmembers', ['hidden'])


    def backwards(self, orm):
        # Removing index on 'GroupMigration', fields ['hidden']
        db.delete_index('vkontakte_groups_groupstatmembers', ['hidden'])

        # Removing index on 'GroupMigration', fields ['time']

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vkontakte_groups_migration_groupmembership', (
        ...
        db.send_create_signal(u'vkontakte_groups_migration', ['GroupMembership'])

        # Adding unique constraint on 'GroupMembership', fields ['group', 'user_id', 'time_entered']
        db.create_unique(u'vkontakte_groups_migration_groupmembership', ['group_id', 'user_id', 'time_entered'])

        # Adding unique constraint on 'GroupMembership', fields ['group', 'user_id', 'time_left']
        db.create_unique(u'vkontakte_groups_migration_groupmembership', ['group_id', 'user_id', 'time_left'])


    def backwards(self, orm):
        # Removing unique constraint on 'GroupMembership', fields ['group', 'user_id', 'time_left']
        db.delete_unique(u'vkontakte_groups_migration_groupmembership', ['group_id', 'user_id', 'time_left'])

        # Removing unique constraint on 'GroupMembership', fields ['group', 'user_id', 'time_entered']
        db.delete_unique(u'vkontakte_groups_migration_groupmembership', ['group_id', 'user_id', 'time_entered'])

        # Deleting model 'GroupMembership'
        db.delete_table(u'vkontakte_groups_migration_groupmembership')
    ...
    models = {
        ...
        u'vkontakte_groups_migration.groupmembership': {
            'Meta': {'ordering': "('group', 'user_id', 'time_entered')", 'unique_together': "(('group', 'user_id', 'time_entered'), ('group', 'user_id', 'time_left'))", 'object_name': 'GroupMembership'},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'memberships'", 'to': u"orm['vkontakte_groups.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time_entered': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'time_left': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),

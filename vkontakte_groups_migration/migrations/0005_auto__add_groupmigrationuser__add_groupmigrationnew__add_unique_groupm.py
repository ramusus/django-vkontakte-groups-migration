...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupMigrationUser'
        ...
        db.send_create_signal(u'vkontakte_groups_migration', ['GroupMigrationUser'])

        # Adding model 'GroupMigrationNew'
        ...
        db.send_create_signal(u'vkontakte_groups_migration', ['GroupMigrationNew'])

        # Adding unique constraint on 'GroupMigrationNew', fields ['group', 'time']
        db.create_unique('vkontakte_groups_migration_groupmigration', ['group_id', 'time'])


    def backwards(self, orm):
        # Removing unique constraint on 'GroupMigrationNew', fields ['group', 'time']
        db.delete_unique('vkontakte_groups_migration_groupmigration', ['group_id', 'time'])

        # Deleting model 'GroupMigrationUser'
        db.delete_table('vkontakte_groups_migration_groupmigrationuser')

        # Deleting model 'GroupMigrationNew'
    ...
    models = {
        ...
        u'vkontakte_groups_migration.groupmigrationuser': {
            'Meta': {'object_name': 'GroupMigrationUser'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

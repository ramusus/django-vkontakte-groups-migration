...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'GroupMembership', fields ['user_id', 'group', 'time_left']
        db.delete_unique(u'vkontakte_groups_migration_groupmembership', ['user_id', 'group_id', 'time_left'])

        # Removing unique constraint on 'GroupMembership', fields ['user_id', 'time_entered', 'group']
        db.delete_unique(u'vkontakte_groups_migration_groupmembership', ['user_id', 'time_entered', 'group_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'GroupMembership', fields ['user_id', 'time_entered', 'group']
        db.create_unique(u'vkontakte_groups_migration_groupmembership', ['user_id', 'time_entered', 'group_id'])

        # Adding unique constraint on 'GroupMembership', fields ['user_id', 'group', 'time_left']
        db.create_unique(u'vkontakte_groups_migration_groupmembership', ['user_id', 'group_id', 'time_left'])
    ...
    models = {
        ...
        u'vkontakte_groups_migration.groupmembership': {
            'Meta': {'ordering': "('group', 'user_id', 'id')", 'object_name': 'GroupMembership'},
